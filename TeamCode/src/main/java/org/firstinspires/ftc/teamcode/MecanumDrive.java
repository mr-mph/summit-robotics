...
public class MecanumDrive {
    public static class Params {
        ...
        public double lateralInPerTick = 0.7335902211801723; // Tune this with LateralRampLogger (even if you use OTOS/Pinpoint)
        public double trackWidthTicks = 11.1069374855074;

        // feedforward parameters (in tick units)
        public double kS = 0.7606537971890472;
        public double kV = 0.19383575736693137;
