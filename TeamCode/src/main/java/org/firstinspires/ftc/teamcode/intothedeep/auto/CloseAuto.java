...

{
	...
	public void runOpMode()
	{
		...
		TrajectoryActionBuilder auto = drive.actionBuilder(new Pose2d(new Vector2d(6, -30), Math.toRadians(90)))
				.strafeTo(new Vector2d(36,-39))
				.turn(Math.toRadians(90))
				.strafeTo(new Vector2d(42,-12))
				.strafeTo(new Vector2d(51,-17))
				.strafeTo(new Vector2d(51,-62))
				.strafeTo(new Vector2d(51,-17))
				.strafeTo(new Vector2d(62-2,-17))
				.strafeTo(new Vector2d(62-2,-62))
				.strafeTo(new Vector2d(62-4,-17))
//				.strafeTo(new Vector2d(68-3,-17))
//				.strafeTo(new Vector2d(68-3,-62))
